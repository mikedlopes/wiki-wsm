...
**Convention:** Live jobs use `projects/<ProjectID>/` (e.g. `TI-2026-045`). New jobs are cloned from `projects/template-project/` — not from a literal `[project-id]` folder name.
